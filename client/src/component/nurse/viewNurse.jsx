...
class dashboard extends Component {
    ...
    onSubmit = (event) => {
        ...
        this.props.navigate(`/edit-Nurse/${firstname}-${lastname}`, { state: this.props.location.state });
    ...
    render() {
        ...
        const { firstname, lastname, dob, address, tel, email, ward, position, appointment, image } = this.state.profile;
