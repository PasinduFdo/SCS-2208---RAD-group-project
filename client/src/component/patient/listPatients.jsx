...
class listPatients extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`http://localhost:8080/patient/list`).then(async (res) => {
        ...
        axios.get(`http://localhost:8080/patient/wards`).then(async (res) => {
    ...
    onSearchAll = () => {
        ...
        document.getElementById('dropdownMenuLink').innerHTML = 'Wards';
    ...
    onSearch = (ward) => {
        ...
        axios.get(`http://localhost:8080/patient/list/${ward}`).then(async (res) => {
    ...
    onDelete = (id) => {
        ...
        axios.delete(`http://localhost:8080/patient/delete/${id}`).then(async (res) => {
            ...
            <>
                <header id="header" className="fixed-top d-flex align-items-center header-transparent">
                    <div className="container d-flex align-items-center justify-content-between">
                        ...
                        <div className="logo">
                            <h1><a href="#"><span>Patient</span></a></h1>
                        </div>

                        <nav id="navbar" className="navbar">
                            <ul>
                                <li><a className="nav-link scrollto logout" onClick={this.addPatient}>Add Patient</a></li>
                            </ul>
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">Patient</li>
                    </ol>
                </nav>
                        ...
                        <div className="ld col-sm-6" key={index}>
                            <div className="ld card">
                                <div className="ld card-body">
                                    ...
                                    <p className="card-text">{profile.nic}</p>
...
export default addHookTo(listPatients);
